...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    copilot.leftTrigger().whileTrue(elevatorintake);
    copilot.leftBumper().whileTrue(elevatorl1);
    copilot.rightBumper().whileTrue(elevatorl2);
    copilot.rightTrigger().whileTrue(elevatorl3);
    copilot.y().whileTrue(elevatorl4);
